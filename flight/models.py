...
class Flight(models.Model):
    ...
    depart_date = models.DateField(default=datetime.now, blank=True)
    arrive_date = models.DateField(default=datetime.now, blank=True)
    ...
    economy_num_places = models.IntegerField(null=True)
    business_num_places = models.IntegerField(null=True)
